...
(function($, Drupal) {
    ...
    Drupal.behaviors.carousel = {
        ...
        attach() {
            let $carousel = $('.articlesMobileCarousel');
...
(function($, Drupal) {
    Drupal.behaviors.carousel = {
        attach: function attach() {
            var $carousel = $('.articlesMobileCarousel'),
                initCarousel = function initCarousel() {
                    if (window.matchMedia("(max-width: 767px)").matches) {
                        if (!$carousel.hasClass('slick-initialized')) $carousel.slick({
                            variableWidth: true,
                            arrows: false,
                            infinite: false
                        })
...
"use strict";
(function($, Drupal) {
    Drupal.behaviors.submitParcelForm = {
        setError: function setError(element) {
            element.addClass("-error");
            element.after(Drupal.theme("error"))
        },
        ...
        attach: function attach(context) {
            var numberRule = new RegExp('^[0-9]{24}$'),
                $form = $(".hero--form--container", context),
                $btn = $form.find("button");
            $form.find("input").on('change', function() {
                if (numberRule.test($(this).val())) {
                    Drupal.behaviors.submitParcelForm.removeError($(this));
                    $btn.removeAttr("disabled")
                } else {
                    Drupal.behaviors.submitParcelForm.setError($(this));
    ...
    $.extend(Drupal.theme, {
        error: function error() {
            return '<div class="form-item--error-message error--block">' + Drupal.t("Provide one parcel number, containing 24 digits") + '</div>'
        }
    })
})(jQuery, Drupal);
(function($, Drupal) {
    ...
    Drupal.Ajax.prototype.success = function(response, status) {
        ...
        Object.keys(response || {}).forEach(function(i) {
            if (response[i].command && _this.commands[response[i].command]) {
                ...
                if (response[i].command === 'invoke' && response[i].method === 'focus') focusChanged = true
            }
        });
...
(function($, Drupal) {
    ...
    Drupal.behaviors.appBanner = {
        attach: function(context) {
            $(context).find('.app-banner').one('app-banner').each(function() {

                var bannerClosed = $.cookie('appBannerClosed');
                if (bannerClosed === undefined || !bannerClosed) {
                    var link = null;
                    var isMobile = {
                        Android: function() {
                    ...
                    if (isMobile.Android()) {
                        link = drupalSettings.androidLink;
                    } else if (isMobile.iOS()) {
                        link = drupalSettings.iosLink;
                    }
                    if (link) {
                        if (drupalSettings && drupalSettings.path && drupalSettings.path.currentLanguage === "en") {
                            var content = `<div class="container"><div class="row no-gutters align-items-center"><div class="col-1"><a href="#app-banner" class="banner-close"><i class="icon-close"></i></a></div><div class="col-2 col--logo"><img class="img-responsive" alt="Logotyp aplikacji InPost Mobile" src="/themes/custom/inpost/images/app-logo.png"></div><div class="col-6 d-flex flex-column justify-content-center col--text"><p><strong>Ship without labels, open&nbsp;remotely!</strong></p><p>Discover the InPost Mobile app</p></div><div class="col-3 col--last"><a class="btn" href="${link}">Download</a></div></div></div>`
                        } else {
                            var content = `<div class="container"><div class="row no-gutters align-items-center"><div class="col-1"><a href="#app-banner" class="banner-close"><i class="icon-close"></i></a></div><div class="col-2 col--logo"><img class="img-responsive" alt="Logotyp aplikacji InPost Mobile" src="/themes/custom/inpost/images/app-logo.png"></div><div class="col-6 d-flex flex-column justify-content-center col--text"><p><strong>Wysyłaj bez etykiety, otwieraj&nbsp;zdalnie!</strong></p><p>Odkryj aplikację InPost Mobile</p></div><div class="col-3 col--last"><a class="btn" href="${link}">Pobierz</a></div></div></div>`
                        }
                        $(context).find('.app-banner').html(content);
                    }
                }

            });
            $('.banner-close', context).click(function(e) {
                e.preventDefault();
                $(this).closest('.app-banner').hide();

                $.cookie('appBannerClosed', true, {
                    expires: 14,
                    secure: true
                });
            });
